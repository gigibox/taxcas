...
// 2018-09-26 17:22:25.090108635 +0800 CST m=+0.036756101
...
var doc = `{
    ...
    "paths": {
        ...
        "/api/v1/admin/images/certs/{certid}/{wechatid}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/weixin/images/certs/{certid}/{wechatid}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
