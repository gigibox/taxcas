...
// 2018-09-20 15:18:16.135207044 +0800 CST m=+0.034139735
...
var doc = `{
    ...
    "paths": {
        ...
        "/api/v1/admin/cert/applicants/{cert_id}/{action}": {
            "get": {
        ...
        "/api/v1/admin/export/cert/{cert_id}/{action}": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "/api/v1/admin/import/cert/{cert_id}/{action}": {
            "post": {
                "produces": [
                    "application/json"
                ],
