...
// 2018-09-27 20:05:39.224006416 +0800 CST m=+0.035006177
    ...
    "paths": {
        ...
        "/api/v1/admin/applicants/certs/{certid}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "file_path: 导入的csv文件路径, action: passed(审核中) | refunded(已拒绝), pids[]: 选中的记录",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/admin/images/certs/{certid}/{pid}": {
            "get": {
                "tags": [
                    "后台管理"
                ],
        ...
        "/api/v1/weixin/e-certs/certs/{certid}/{openid}": {
            "get": {
                "tags": [
                    "微信公众号"
                ],
